			...
			<div class="border border-secondary m-3 p-2">
				<table class="table table-hover border border-secondary ">
					<tbody>
						...
						<tr class="table-primary fs-6">
							<th>Batch Number</th>
							<td>${st.studentBatchNumber}</td>
						</tr>
						<tr class="table-danger fs-6">
							<th>Fees Paid</th>
							<td>${st.studentFeesPaid}</td>
						</tr>
				...
				<form action="shift">
					...
					<div class="bg-dark p-2 d-flex justify-content-between">
						<label for="amount" class="text-info"><b>Select Batch to shift
							
						</b></label> <select class="select form-control-sm border border-primary"
